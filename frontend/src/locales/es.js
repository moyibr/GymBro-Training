...
export default {
  ...
  "This browser doesn't support passkeys — you can still use GymBro locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar GymBro localmente en este dispositivo.',
  ...
  'to install GymBro as a full-screen app.': 'para instalar GymBro como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if GymBro is closed.': 'Avisos del temporizador de descanso, incluso con GymBro cerrado.',
  ...
  'A small file a friend imports into their own GymBro — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio GymBro: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Self-host GymBro': 'Aloja GymBro tú mismo',
